...
import { RockType } from "./type_rock";
import { Pokemon } from "./interface_pokemon";
import { PokemonType } from "./types";

/**
 * Concrete implementation of the class rock pokemon that
 ...
 */
export class RockTypeCreator extends PokemonCreator {
    /**
    ...
    public factoryMethod(): Pokemon {
      return new RockType(this.name, this.health, this.damage, this.pokemonType);
    }
  }