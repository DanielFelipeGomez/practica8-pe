...
/**
 * Class that provides a concrete implementation of a rock pokemon object
 */
export class RockType implements Pokemon {
  /**
     * class constructor that models a Rock type pokemon
     * @param name 
     * @param health 
     * @param damage 
     * @param pokemonType Rock, fire, rock , dark, ...
     */
